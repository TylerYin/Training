    ...
    private static void buyTicket() throws IOException {
        ...
        if (null == findClient) {
            ...
            for (Activity activity : activities) {
                if (activity.getActivityName().equals(inputStr)) {
                    validActivity = true;
                    break;
                }
            }
            ...
            if (!validActivity) {
                ...
                if (duplicateBuy) {
                    ...
                    if (findActivity.getRemainNum() <= 0) {
                        ...
                        fileWriter.write("there is no enough ticket!");
                        fileWriter.flush();
        ...
        if (null == findClient) {
            ...
            if (!validActivity) {
                ...
                while (clientActivityIt.hasNext()) {
                    ...
                    if (a.getActivityName().equals(inputStr)) {
